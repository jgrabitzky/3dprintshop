...
function calcCPPrice(volume, area) {
  ...
  let finalPrice = Math.round(outerShellVolume * DENSITY + innerVolume * DENSITY * 0.5) * PRICE_PER_GRAMM * 7 * EXCHANGE_RATE;
  //let finalPrice = finalPriceFt * EXCHANGE_RATE;
  console.log("Aussenvolumen", outerShellVolume * DENSITY);
